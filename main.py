...
BOT_RESPONSES = {
    ...
    ⚠️ <b>Importante:</b> Una vez pagado, envía el justificante por WhatsApp al director o al email de contacto para tramitarlo. Les recordamos que la temporada empieza en enero 2026, les recomendamos encarecidamente federarse antes del 20 de enero del 2026.
    """,
    "LICHESS": """
    ...
    """,
    "CHANNEL": """
    🎬 <b>¡Visita nuestro Canal de YouTube!</b><br><br>
    
    Ahí subimos contenido genial para que sigas aprendiendo:<br>
    ♟️ <b>Análisis</b> de partidas.<br>
    🎓 <b>Clases</b> grabadas.<br>
